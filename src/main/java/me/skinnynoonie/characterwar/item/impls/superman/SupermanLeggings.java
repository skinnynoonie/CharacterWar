...
public class SupermanLeggings implements CustomItemImpl {
    ...
    public @NotNull ItemStack getItem() {
        ...
        return new ItemBuilder(Material.LEATHER_LEGGINGS)
                ...
                .setColor(Color.BLUE)
                .setUnbreakable(true)
                .editMeta(meta -> meta.getPersistentDataContainer().set(key, PersistentDataType.STRING, "superman_leggings"))
                .build();
    }
