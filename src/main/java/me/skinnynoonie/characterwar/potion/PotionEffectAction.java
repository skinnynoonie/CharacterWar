...
public class PotionEffectAction {
    ...
    public PotionEffectAction(@NotNull UUID playerUUID, @NotNull PotionEffect potionEffect, boolean removeBeforeApply) {
    ...
    public @NotNull PotionEffect getPotionEffect() {
